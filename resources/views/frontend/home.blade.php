                    ...
                    <div class="row-table">
                                    ...
                                    <nav class="rs-menu hidden-md">
                                        <ul class="nav-menu">
                                            ...
                                            <li class="menu-item-has-children">
                                                <a href="#">About</a>
                                                <ul class="sub-menu">
                                                    <li><a href="">About the conference
                                                        </a></li>
                                                    <li><a href="">Scope of the conference</a></li>
                                                    <li><a href="">Organization committee</a></li>
                                                    <li><a href="">Program schedule</a></li>
                                                    <li><a href="">Co-host Malaysia</a></li>
                                            ...
                                            <li class="menu-item-has-children">
                                                <a href="#">SPEAKER</a>
                                                <ul class="sub-menu">
                                                    <li><a href="">Invited guest</a></li>
                                                    <li><a href="">keynote speaker</a></li>
                                                    <li><a href="">plenary speaker</a></li>
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="">Strategic partner</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="col-cell">
                            <div class="expand-btn-inner">
                                <ul>
                                    <li class="btn-quote">
                                        <a href="" class="quote-button">Registration</a>
                                    </li>
                                    <li class="humburger">
