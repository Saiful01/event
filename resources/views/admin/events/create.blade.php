...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="registration_rules">{{ trans('cruds.event.fields.registration_rules') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('registration_rules') ? 'is-invalid' : '' }}" name="registration_rules" id="registration_rules">{!! old('registration_rules') !!}</textarea>
                @if($errors->has('registration_rules'))
                    <div class="invalid-feedback">
                        {{ $errors->first('registration_rules') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.registration_rules_helper') }}</span>
            </div>
            <div class="form-group">
