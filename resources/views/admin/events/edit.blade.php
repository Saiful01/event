    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('registration_rules') ? 'is-invalid' : '' }}" name="registration_rules" id="registration_rules">{!! old('registration_rules', $event->registration_rules) !!}</textarea>
