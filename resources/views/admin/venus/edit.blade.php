...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.venu.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.venus.update", [$venu->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="suggested_accommodation">{{ trans('cruds.venu.fields.suggested_accommodation') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('suggested_accommodation') ? 'is-invalid' : '' }}" name="suggested_accommodation" id="suggested_accommodation">{!! old('suggested_accommodation', $venu->suggested_accommodation) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('host_venu') ? 'is-invalid' : '' }}" name="host_venu" id="host_venu">{{ old('host_venu', $venu->host_venu) }}</textarea>
