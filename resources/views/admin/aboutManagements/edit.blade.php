    ...
    <div class="card-body">
       ...
       {{--     <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_1') ? 'is-invalid' : '' }}" type="text" name="link_1" id="link_1" value="{{ old('link_1', $aboutManagement->link_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_2') ? 'is-invalid' : '' }}" type="text" name="link_2" id="link_2" value="{{ old('link_2', $aboutManagement->link_2) }}">
