    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.about-managements.update", [$aboutManagement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('welcome_message') ? 'is-invalid' : '' }}" name="welcome_message" id="welcome_message">{{ old('welcome_message', $aboutManagement->welcome_message) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_text') ? 'is-invalid' : '' }}" name="about_text" id="about_text">{{ old('about_text', $aboutManagement->about_text) }}</textarea>
