...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.aboutManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.about-managements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('about_the_conference') ? 'is-invalid' : '' }}" name="about_the_conference" id="about_the_conference">{!! old('about_the_conference') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('scope_of_the_conference') ? 'is-invalid' : '' }}" name="scope_of_the_conference" id="scope_of_the_conference">{!! old('scope_of_the_conference') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('program_schedule') ? 'is-invalid' : '' }}" name="program_schedule" id="program_schedule">{!! old('program_schedule') !!}</textarea>
